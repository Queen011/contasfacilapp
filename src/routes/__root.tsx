...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Contas Fácil" },
      { name: "description", content: "Gerencie suas contas, recorrentes e avulsas, em um só lugar." },
      { property: "og:title", content: "Contas Fácil" },
      { name: "twitter:title", content: "Contas Fácil" },
      { property: "og:description", content: "Gerencie suas contas, recorrentes e avulsas, em um só lugar." },
      { name: "twitter:description", content: "Gerencie suas contas, recorrentes e avulsas, em um só lugar." },
